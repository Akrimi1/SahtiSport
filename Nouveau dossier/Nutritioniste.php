...
class Nutritioniste implements UserInterface
{
    ...
    protected $captchaCode;
     ...
     /**
     * @ORM\OneToMany(targetEntity=Reclamations::class, mappedBy="Nutritioniste")
     */
    ...
    public function addReclamation(Reclamations $reclamation): self
    {
        if (!$this->reclamations->contains($reclamation)) {
            ...
            $reclamation->setNutritioniste($this);
        }
    ...
    public function removeReclamation(Reclamations $reclamation): self
    {
        if ($this->reclamations->removeElement($reclamation)) {
            ...
            if ($reclamation->getNutritioniste() === $this) {
                $reclamation->setNutritioniste(null);
            }
        }
