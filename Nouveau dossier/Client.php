...
class Client implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Commandes::class, mappedBy="client", orphanRemoval=true)
     */
    private $commandes;
     /**
     * @ORM\OneToMany(targetEntity=Reclamations::class, mappedBy="client", orphanRemoval=true)
     */
